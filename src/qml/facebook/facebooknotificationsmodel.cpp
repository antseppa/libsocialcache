...
void FacebookNotificationsModel::notificationsChanged()
{
    ...
    Q_FOREACH (const FacebookNotification::ConstPtr &notification, notificationsData) {
        ...
        qDebug("!* ANTTI: fbID: %s", qPrintable(notification->facebookId()));
        ...
        qDebug("!* ANTTI: appId: %s", qPrintable(notification->application()));
        qDebug("!* ANTTI: object: %s", qPrintable(notification->object()));
        qDebug("!* ANTTI: accountId: %s", qPrintable(notification->accountId()));
        ...
        eventMap.insert(FacebookNotificationsModel::AccountId, notification->accountId());
